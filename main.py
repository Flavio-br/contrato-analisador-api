...
def _send_email_brevo(to_email: str, subject: str, html: str, attachment_name: Optional[str]=None, attachment_bytes: Optional[bytes]=None) -> tuple[bool, Optional[str]]:
...
"""
        ...
        # ✅ Enquanto Brevo não estiver configurado, não tenta enviar e não acusa falha no front
